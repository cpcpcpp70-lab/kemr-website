      ...
      <div className="max-w-5xl mx-auto px-6 py-16">
        ...
        <div className="w-full bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden mb-4">
          ...
          >
            ...
            <text x="300" y="200" textAnchor="middle" fontSize="11" fontWeight="bold" fill="#3b82f6">← 도보 15분</text>
            ...
            <text x="74" y="268" textAnchor="middle" fontSize="9" fill="#64748b">11번 출구</text>
            ...
            <text x="56" y="369" fontSize="10" fill="#475569">강남역 도보경로 (15분)</text>
            ...
            <div className="space-y-4">
              <div className="border-l-4 border-green-500 pl-4">
                ...
                <p className="text-gray-600 text-sm">
                  2호선 역삼역 <strong>2번 출구</strong> 바로 앞<br />
                  2호선 강남역 11번 출구에서 도보 15분
                </p>
              </div>
